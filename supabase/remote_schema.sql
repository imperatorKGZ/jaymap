...
ALTER FUNCTION "public"."get_listings_geojson"("p_west" double precision, "p_south" double precision, "p_east" double precision, "p_north" double precision, "p_type" "text", "p_city_id" "text", "p_price_min" integer, "p_price_max" integer, "p_rooms" integer, "p_area_min" integer, "p_area_max" integer, "p_furnished" boolean, "p_parking" boolean, "p_pets" boolean, "p_params" "jsonb") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."listings" (
    ...
    "search_vector" "tsvector" GENERATED ALWAYS AS ((("setweight"("to_tsvector"('"russian"'::"regconfig", COALESCE("title", ''::"text")), 'A'::"char") || "setweight"("to_tsvector"('"russian"'::"regconfig", COALESCE("description", ''::"text")), 'B'::"char")) || "setweight"("to_tsvector"('"russian"'::"regconfig", COALESCE("address", ''::"text")), 'C'::"char"))) STORED,
    "status" "text" DEFAULT 'draft'::"text" NOT NULL,
    CONSTRAINT "listings_status_check" CHECK (("status" = ANY (ARRAY['draft'::"text", 'published'::"text", 'paused'::"text", 'archived'::"text"]))),
    CONSTRAINT "listings_type_check" CHECK (("type" = ANY (ARRAY['rental'::"text", 'commercial'::"text", 'land'::"text", 'daily'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    CONSTRAINT "profiles_role_check" CHECK (("role" = ANY (ARRAY['user'::"text", 'realtor'::"text", 'admin'::"text"]))),
...
ALTER TABLE ONLY "public"."listing_views"
    ADD CONSTRAINT "listing_views_pkey" PRIMARY KEY ("user_id", "listing_id");
...
CREATE INDEX "idx_listings_area" ON "public"."listings" USING "btree" ("area") WHERE ("area" IS NOT NULL);
...
CREATE INDEX "idx_listings_geo" ON "public"."listings" USING "gist" ("coordinates");



CREATE INDEX "idx_listings_owner_status" ON "public"."listings" USING "btree" ("user_id", "status");



CREATE INDEX "idx_listings_params" ON "public"."listings" USING "gin" ("params");



CREATE INDEX "idx_listings_premium" ON "public"."listings" USING "btree" ("is_premium") WHERE ("is_premium" = true);
...
CREATE INDEX "idx_listings_rooms" ON "public"."listings" USING "btree" ("rooms") WHERE ("rooms" IS NOT NULL);
...
CREATE INDEX "listing_views_listing_idx" ON "public"."listing_views" USING "btree" ("listing_id");



CREATE INDEX "listing_views_user_viewed_idx" ON "public"."listing_views" USING "btree" ("user_id", "viewed_at" DESC);
...
ALTER TABLE ONLY "public"."listing_views"
    ADD CONSTRAINT "listing_views_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "listing_views_delete_own" ON "public"."listing_views" FOR DELETE TO "authenticated" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "listing_views_insert_own" ON "public"."listing_views" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "listing_views_select_own" ON "public"."listing_views" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "listing_views_update_own" ON "public"."listing_views" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "listings_select_own" ON "public"."listings" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));
...
REVOKE ALL ON FUNCTION "public"."get_listing_contacts"("p_listing_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_listing_contacts"("p_listing_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_listing_contacts"("p_listing_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_listing_contacts"("p_listing_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_listings_geojson"("p_west" double precision, "p_south" double precision, "p_east" double precision, "p_north" double precision, "p_type" "text", "p_city_id" "text", "p_price_min" integer, "p_price_max" integer, "p_rooms" integer, "p_area_min" integer, "p_area_max" integer, "p_furnished" boolean, "p_parking" boolean, "p_pets" boolean, "p_params" "jsonb") TO "anon";
...
REVOKE ALL ON FUNCTION "public"."get_my_listing_history"() FROM PUBLIC;
...
GRANT ALL ON FUNCTION "public"."get_public_listing"("p_listing_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_public_listing"("p_listing_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_public_listing"("p_listing_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."record_listing_view"("p_listing_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."record_listing_view"("p_listing_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."record_listing_view"("p_listing_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."record_listing_view"("p_listing_id" "uuid") TO "service_role";
